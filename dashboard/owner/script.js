...
function updateStats() {
  document.getElementById("acctStatTotal").textContent    = allUsers.length;
...
function acctRenderStats() {
  ...
  document.getElementById('acctStatTotal').textContent =
    a.length;
  document.getElementById('acctStatConnected').textContent =
    a.filter(x => x.status === 'active').length;
  document.getElementById('acctStatWarning').textContent =
    a.filter(x => x.status === 'warning').length;
  document.getElementById('acctStatArchived').textContent =
    a.filter(x => x.status === 'archived').length;
}
